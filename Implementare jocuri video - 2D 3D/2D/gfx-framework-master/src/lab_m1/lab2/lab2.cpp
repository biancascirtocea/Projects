...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(0.5, 0.3, 0.2)),
			VertexFormat(glm::vec3(1, 0,  1), glm::vec3(0.4, 0.6, 0.4)),
			VertexFormat(glm::vec3(0, 1,  1), glm::vec3(0.3, 0.5, 0.7)),
			VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0.9, 0.8, 0.5)),
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0.2, 0.2, 0.2)),
			VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0.7, 0.4, 0.4)),
			VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0.4, 0.5, 0.6)),
			VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0.6, 0.5, 0.8))
...

    {
		...
		CreateMesh("tetraedru", vertices_tetraedru, indices);
    }

    {
		...
		CreateMesh("square", vertices_square, indices);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
	...
	//RenderMash(meshes["cube_B"], shaders["VertexColor"], glm::vec3(0, 0.5f, 0), glm::vec3(0.25f)

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(1.5f, 0.5f, 0), glm::vec3(1.5f));

    // TODO(student): Draw the square
	RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1, 2, 1), glm::vec3(0.5f));
