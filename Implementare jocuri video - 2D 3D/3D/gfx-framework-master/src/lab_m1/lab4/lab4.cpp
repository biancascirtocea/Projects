...
void Lab4::Init()
{
    ...
    Mesh* soare = new Mesh("sphere");
    soare->LoadMesh(PATH_JOIN(window->props.selfDir, RESOURCE_PATH::MODELS, "primitives"), "sphere.obj");
    meshes[soare->GetMeshID()] = soare;

    Mesh* pamant = new Mesh("sphere");
    pamant->LoadMesh(PATH_JOIN(window->props.selfDir, RESOURCE_PATH::MODELS, "primitives"), "sphere.obj");
    meshes[pamant->GetMeshID()] = pamant;

    Mesh* luna = new Mesh("sphere");
    luna ->LoadMesh(PATH_JOIN(window->props.selfDir, RESOURCE_PATH::MODELS, "primitives"), "sphere.obj");
    meshes[luna->GetMeshID()] = luna;
