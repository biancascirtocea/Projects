...
//
//			glm::mat3 aux = glm::mat3(glm::rotate(glm::mat4(1), angle, right));
//			forward = glm::normalize(aux * forward);
//			up = glm::normalize(aux * up);
//
//        }
//
...
//            // vectors!
//
//			glm::mat3 aux = glm::mat3(glm::rotate(glm::mat4(1), angle, glm::vec3(0,1,0)));
//			forward = glm::normalize(aux * forward);
//			right = glm::normalize(aux * right);
//			up = glm::normalize(aux * up);
//
//
//        }
...
//
//			glm::mat3 aux = glm::mat3(glm::rotate(glm::mat4(1), angle, forward));
//			right = glm::normalize(aux * right);
//			up = glm::normalize(aux * up);
//
//        }
